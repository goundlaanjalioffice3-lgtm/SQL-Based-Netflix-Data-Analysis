# <p align="center">SQL-Based Netflix Data Analysis</p>
...
Performed SQL-based analysis on the Netflix Movies and TV Shows dataset to extract meaningful insights from large-scale data.
• Designed and executed optimized SQL queries using filtering, joins, grouping, and aggregate functions to analyze content trends.
• Analyzed movie vs TV show distribution, genre popularity, release year trends, ratings, and country-wise content availability.
• Cleaned and structured raw data to improve query accuracy and ensure reliable analysis results.
• Used Tools & Technologies: MySQL, SQL, Excel.
